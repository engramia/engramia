"""Security middleware for the Remanence API.
...
RateLimitMiddleware
    ...
    Configure via env vars:
        REMANENCE_RATE_LIMIT_DEFAULT   (default 60 req/min)
        REMANENCE_RATE_LIMIT_EXPENSIVE (default 10 req/min)

BodySizeLimitMiddleware
    Rejects requests whose Content-Length header exceeds the configured max.
    Configure via env var:
        REMANENCE_MAX_BODY_SIZE (bytes, default 1 048 576 = 1 MB)
"""
