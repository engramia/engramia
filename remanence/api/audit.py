"""Structured audit logging for the Remanence API.
...
Output goes to the ``remanence.audit`` logger at WARNING level so that
...
_audit_log = logging.getLogger("remanence.audit")
