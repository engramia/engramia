"""Lightweight Python SDK client for the Remanence REST API.
...
class RemanenceWebhookError(Exception):
...
class RemanenceWebhook:
    """HTTP client for the Remanence REST API.
    ...
    def _request(self, method: str, path: str, body: dict | None = None) -> dict:
        ...
        try:
            ...
            raise RemanenceWebhookError(exc.code, detail) from exc
        except urllib.error.URLError as exc:
            raise RemanenceWebhookError(0, f"Connection failed: {exc.reason}") from exc
