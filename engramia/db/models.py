...
class BillingSubscription(Base):
    ...
    plan_tier: Mapped[str] = mapped_column(Text, nullable=False, server_default="developer")
    billing_interval: Mapped[str] = mapped_column(Text, nullable=False, server_default="month")
    status: Mapped[str] = mapped_column(Text, nullable=False, server_default="active")
    eval_runs_limit: Mapped[int | None] = mapped_column(Integer, nullable=True, server_default="5000")
    patterns_limit: Mapped[int | None] = mapped_column(Integer, nullable=True, server_default="10000")
