"""Lightweight Python SDK client for the Agent Brain REST API.
...
class BrainWebhookError(Exception):
...
class BrainWebhook:
    """HTTP client for the Agent Brain REST API.
    ...
    def _request(self, method: str, path: str, body: dict | None = None) -> dict:
        ...
        try:
            ...
            raise BrainWebhookError(exc.code, detail) from exc
        except urllib.error.URLError as exc:
            raise BrainWebhookError(0, f"Connection failed: {exc.reason}") from exc
